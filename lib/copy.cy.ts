...
export const copyCy: Copy = {
  ...
  empty: {
    ...
    noPeopleWhy:
      'Y pwll yw’r hyn y gall y sefydliad ei faesu. Ychwanegwch berson gyda’r ffurflen ar y dudalen hon, yna neilltuwch rôl.',
    noSignals:
  ...
  people: {
    ...
    addPersonAction: 'Ychwanegu person',
    assignRole: 'Neilltuo rôl…',
    role: 'Rôl',
    name: 'Enw',
    email: 'E-bost',
    noRolesYet: 'Dim rolau yn y dyluniad eto, felly ni ellir neilltuo rôl.',
    addFailed: 'Methu ychwanegu’r person hwnnw. Rhowch gynnig arall.',
    assignFailed: 'Methu neilltuo’r rôl honno. Rhowch gynnig arall.',
    remove: 'Tynnu',
    roleForPerson: '{name}: rôl',
    lockedToLive: 'Nid yw’r ymgysylltiad hwn wedi’i rwymo at y dyluniad byw, felly ni ellir golygu’r pwll yma.',
    noEmail: 'Dim e-bost',
    unassigned: 'Heb neilltuo',
    assignedTo: 'Neilltuwyd: {roles}',
    emailAndFte: '{email} · {fte}% FTE',
  ...
  assurance: {
    ...
    whatItAsks: 'Beth y mae’n ei ofyn',
    laterPhase: 'cyfnod hwyrach',
    onTrack: 'ar y trywydd',
    atRisk: 'mewn perygl',
    fixableByAssignment: 'Gellir ei drwsio drwy neilltuo',
    fixableNote: 'dim angen newid proses',
    ofTotal: 'o {total}',
    teachingIndex: '0.64',
    teachingIndexNote: 'Safon Gwasanaeth Digidol Cymru, darganfod',
    teachingFixable: '3',
    teachingHint:
      'Mae tri o’r pedwar perygl yn cau drwy newid pwy sydd ar y tîm. Dim ond hygyrchedd sydd angen recriwtio.',
    teachingPoints: [
      {
        ref: '1',
        title: 'Deall defnyddwyr a’u hanghenion',
        status: 'at-risk',
        why: 'Ymchwilydd defnyddwyr arweiniol islaw’r datum',
      },
      { ref: '2', title: 'Datrys problem gyfan i ddefnyddwyr', status: 'on-track', why: '' },
      { ref: '3', title: 'Darparu profiad cysylltiedig', status: 'on-track', why: '' },
      { ref: '4', title: 'Gwneud y gwasanaeth yn hawdd i’w ddefnyddio', status: 'later-phase', why: 'Alpha' },
      {
        ref: '5',
        title: 'Sicrhau y gall pawb ddefnyddio’r gwasanaeth',
        status: 'at-risk',
        why: 'Dim arbenigwr hygyrchedd yn y pwll o gwbl',
      },
      {
        ref: '6',
        title: 'Cael tîm amlddisgyblaethol',
        status: 'at-risk',
        why: 'Dwy rôl hanfodol islaw’r datum',
      },
      {
        ref: '7',
        title: 'Defnyddio ffyrdd ystwyth o weithio',
        status: 'on-track',
        why: 'Disgyblaeth capasiti wedi’i thystio ar draws y cyfnod',
      },
      { ref: '8', title: 'Ailadrodd a gwella yn aml', status: 'on-track', why: '' },
      { ref: '9', title: 'Creu gwasanaeth diogel', status: 'later-phase', why: 'Alpha' },
      {
        ref: '10',
        title: 'Diffinio sut olwg sydd ar lwyddiant',
        status: 'at-risk',
        why: 'Dadansoddwr perfformiad ar 0.2 FTE',
      },
      { ref: '11', title: 'Dewis y offer a’r dechnoleg gywir', status: 'on-track', why: '' },
      { ref: '12', title: 'Gwneud y cod ffynhonnell newydd yn agored', status: 'later-phase', why: 'Alpha' },
      { ref: '13', title: 'Defnyddio a chyfrannu at safonau agored', status: 'on-track', why: '' },
      { ref: '14', title: 'Gweithredu gwasanaeth dibynadwy', status: 'later-phase', why: 'Beta' },
    ],
  },
  ...
  portfolio: {
    ...
    passFirstTime: 'Pasio y tro cyntaf',
    passWant: 'rydym eisiau uwchben 70%',
    evidenceReady: 'Tystiolaeth yn barod',
    evidenceReadyNote: 'wedi’i chydosod, nid ei hysgrifennu’n ddiweddarach',
    teachingEngagementsNote: '2 darganfod, 2 beta',
    teachingBelow: '9',
    teachingBelowNote: 'o 31 wedi’u llenwi',
    teachingPass: '67%',
    teachingEvidence: '88%',
    liveHeading: 'Yn y sefydliad hwn',
    teachingRows: [
      {
        name: 'Gwasanaeth Trwyddedu CNC',
        phase: 'Darganfod',
        gate: 'Porth 1, 6 wythnos',
        below: '3 o 7',
        risk: true,
        maturity: '2',
      },
      {
        name: 'Cofrestrfa Tir Cyfoeth',
        phase: 'Beta preifat',
        gate: 'Porth 3, 11 wythnos',
        below: '2 o 9',
        risk: false,
        maturity: '3',
      },
      {
        name: 'Data asedau priffyrdd',
        phase: 'Darganfod',
        gate: 'Porth 0, 3 wythnos',
        below: '3 o 6',
        risk: true,
        maturity: '1',
      },
      {
        name: 'Rhaglen gyfalaf ysgolion',
        phase: 'Beta cyhoeddus',
        gate: 'Porth 4, 20 wythnos',
        below: '1 o 9',
        risk: false,
        maturity: '3',
      },
