...
export const cy: Messages = {
  ...
  engagement: {
    ...
    workflowStepTeam: 'Ffit Tîm',
    workflowStepTeamHint: 'Sgorio pobl yn erbyn archetype, yna cadarnhau cynnig sgwad.',
  ...
  teamFit: {
    title: 'Ffit Tîm',
    intro:
      'A oes gennym y bobl iawn i gyflawni hyn, a allwn brofi hynny? Mae sgorau ffit yn dangos sgìl yn erbyn yr archetype a disgyblaeth cyflawni (trylwyredd). Diffyg tystiolaeth trylwyredd yw di-dystiolaeth — nid trylwyredd isel.',
    archetype: 'Archetype',
    computeScores: 'Cyfrifo sgorau ffit',
    managePeople: 'Rheoli pobl',
    proposalLink: 'Cynnig sgwad',
    gapsLink: 'Bylchau gallu',
    computedAt: 'Cyfrifwyd',
    noScoresYet: 'Dim sgorau ffit eto. Dewiswch archetype a chyfrifwch sgorau.',
    viewCandidates: 'Ymgeiswyr',
    bestCandidate: 'Ymgeisydd gorau',
    gapRow: 'Bwlch gallu — dim ymgeisydd hyfyw',
    candidatesTitle: 'Ymgeiswyr',
    noCandidates: 'Dim ymgeiswyr wedi’u sgorio. Cyfrifwch sgorau ffit o’r trosolwg Ffit Tîm.',
    ...
    gapsTitle: 'Bylchau gallu',
    gapsIntro:
      'Mae bylchau yn cysylltu â phwyntiau safon y mae’r archetype yn eu cefnogi — yr un llwybr â’r Mynegai Parodrwydd.',
    noGaps: 'Dim bylchau gallu ar gyfer y dewis hwn.',
    peopleTitle: 'Pobl',
