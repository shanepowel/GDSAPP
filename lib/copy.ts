...
export const copy = {
  ...
  empty: {
    ...
    noPeopleWhy:
      'The pool is what the organisation can field. Add a person with the form on this page, then assign a role.',
    noSignals:
  ...
  people: {
    ...
    addPersonAction: 'Add a person',
    assignRole: 'Assign role…',
    role: 'Role',
    name: 'Name',
    email: 'Email',
    noRolesYet: 'No roles in this design yet, so a role cannot be assigned.',
    addFailed: 'Could not add that person. Try again.',
    assignFailed: 'Could not assign that role. Try again.',
    remove: 'Remove',
    roleForPerson: '{name}: role',
    lockedToLive: 'This engagement is not bound to the live design, so the pool cannot be edited here.',
    noEmail: 'No email',
    unassigned: 'Unassigned',
    assignedTo: 'Assigned: {roles}',
  ...
  assurance: {
    ...
    onTrack: 'on track',
    atRisk: 'at risk',
    fixableByAssignment: 'Fixable by assignment',
    fixableNote: 'no process change needed',
    ofTotal: 'of {total}',
    teachingIndex: '0.64',
    teachingIndexNote: 'Wales DSS, discovery',
    teachingFixable: '3',
    teachingHint:
      'Three of the four risks close by changing who is on the team. Only accessibility needs a hire.',
    teachingPoints: [
      {
        ref: '1',
        title: 'Understand users and their needs',
        status: 'at-risk',
        why: 'Lead user researcher below the datum',
      },
      { ref: '2', title: 'Solve a whole problem for users', status: 'on-track', why: '' },
      { ref: '3', title: 'Provide a joined up experience', status: 'on-track', why: '' },
      { ref: '4', title: 'Make the service simple to use', status: 'later-phase', why: 'Alpha' },
      {
        ref: '5',
        title: 'Make sure everyone can use the service',
        status: 'at-risk',
        why: 'No accessibility specialist anywhere in the pool',
      },
      {
        ref: '6',
        title: 'Have a multidisciplinary team',
        status: 'at-risk',
        why: 'Two essential roles below the datum',
      },
      {
        ref: '7',
        title: 'Use agile ways of working',
        status: 'on-track',
        why: 'Capacity discipline evidenced across the phase',
      },
      { ref: '8', title: 'Iterate and improve frequently', status: 'on-track', why: '' },
      { ref: '9', title: 'Create a secure service', status: 'later-phase', why: 'Alpha' },
      {
        ref: '10',
        title: 'Define what success looks like',
        status: 'at-risk',
        why: 'Performance analyst at 0.2 FTE',
      },
      { ref: '11', title: 'Choose the right tools and technology', status: 'on-track', why: '' },
      { ref: '12', title: 'Make new source code open', status: 'later-phase', why: 'Alpha' },
      { ref: '13', title: 'Use and contribute to open standards', status: 'on-track', why: '' },
      { ref: '14', title: 'Operate a reliable service', status: 'later-phase', why: 'Beta' },
    ],
  },
  ...
  portfolio: {
    ...
    passWant: 'we want above 70%',
    evidenceReady: 'Evidence ready',
    evidenceReadyNote: 'assembled, not written later',
    teachingEngagementsNote: '2 discovery, 2 beta',
    teachingBelow: '9',
    teachingBelowNote: 'of 31 filled',
    teachingPass: '67%',
    teachingEvidence: '88%',
    liveHeading: 'In this organisation',
    teachingRows: [
      {
      ...
      {
        name: 'Cyfoeth Land Registry',
        phase: 'Private beta',
        gate: 'Gate 3, 11 weeks',
        below: '2 of 9',
        risk: false,
        maturity: '3',
      },
      {
        name: 'Highways asset data',
        phase: 'Discovery',
        gate: 'Gate 0, 3 weeks',
        below: '3 of 6',
        risk: true,
      ...
      {
        name: 'Schools capital programme',
        phase: 'Public beta',
        gate: 'Gate 4, 20 weeks',
        below: '1 of 9',
        risk: false,
        maturity: '3',
      },
